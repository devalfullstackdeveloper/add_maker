    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">AD Maker </div>
            </a>
...
<li class="nav-item dropdown no-arrow">
    ...
    src="{{asset('/public/assets/admin/admin.jpg')}}">
</a>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        @if(isset($upcomingevents_data))
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h5 mb-0 text-gray-800">Upcoming Events</h1>

            <a href="{{route('event.index')}}">
                <span class="icon text-white-50">
                    <i style="font-size:20px"></i>
                </span>
                <span class="text-gray-800">View All</span></a>
            </div>
            <div class="row">
                @foreach ($upcomingevents_data as $up)             
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div >{{ $up->title }}</div>
                                      <img  alt="img" src="{{asset('/storage/app/'.$up->icon)}}" width="330px" height="200px">
                                    </div>                                 
                                </div>
                            </div>
                        </div>
